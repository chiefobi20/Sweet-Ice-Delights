      ...
      <div className="container max-w-6xl mx-auto px-8 py-16">
        <section className="about-hero mb-16">
          ...
          <p className="text-xl text-center text-gray-700 max-w-4xl mx-auto leading-relaxed" >
            Sweet Ice Delights was started by [Owner Name] in [Year] right here in [City], with one cooler, a handful of fresh fruit, and a promise to keep things simple and honest.
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                [Owner Name] grew up around block parties, ball games, and church picnics where a cold cup of Italian ice could turn a hot day around. After years of sharing homemade recipes with family and friends, he decided to bring that same happiness to the whole community. Today, we still make our ices in small batches, using real fruit, pure cane sugar, and filtered water—no shortcuts, ever. Most of our flavors are dairy-free and vegan so everyone can dig in.              </p>
            ...
            <div className="What Makes Us Special">
              ...
              <ul className="space-y-3 text-gray-700" style={{ color: 'lightblue',fontStyle: 'italic', fontWeight: 'bold', fontSize: '25px'}}>
                ...
                <li className="flex items-center"><span className="text-pink-500 mr-3">👨‍👩‍👧‍👦💛</span>  Community first: [schools, teams, and local events]</li>
                <li className="flex items-center"><span className="text-pink-500 mr-3">⭐</span> Fan favorites: [List 4–6 signature flavors]</li>
              </ul>
              <br></br>
